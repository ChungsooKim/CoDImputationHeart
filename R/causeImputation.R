...
causeImputation <- function(outputFolder, TAR){
  ...
  saveFolder <- file.path(outputFolder ,"CoDImputationHeart")
  ...
  ## Result file
  causeName <- data.frame(cause.prediction = c(0:7,99), 
                          CauseName = c("No Death", "Malignant cancer", "Heart disease", 
  ...
  temp <- data.frame(cause.prediction = c(0:7,99))
  ...
  table2[10,2:length(table2)] <-table2[2:length(table2)] %>% summarise_all(funs(sum))
  levels(table2$CauseName) <- c(levels(table2$CauseName), "Total")
  table2$CauseName[10] <- "Total"
  ...
  table5[10,2:length(table5)] <-table5[2:length(table5)] %>% summarise_all(funs(sum))
  levels(table5$CauseName) <- c(levels(table5$CauseName), "Total")
  table5$CauseName[10] <- "Total"
  ...
  table8 <- data.frame(cause.prediction = c(0:7,99))
  for(i in 1:10){
  ...
  table8[10,2:length(table8)] <-table8[2:length(table8)] %>% summarise_all(funs(sum))
  levels(table8$CauseName) <- c(levels(table8$CauseName), "Total")
  table8$CauseName[10] <- "Total"
  ...
  table11[10,2:length(table11)] <-table11[2:length(table11)] %>% summarise_all(funs(sum))
  levels(table11$CauseName) <- c(levels(table11$CauseName), "Total")
  table11$CauseName[10] <- "Total"
