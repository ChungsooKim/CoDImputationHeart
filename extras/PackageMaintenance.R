...
#
# This file is part of CoDImputationHeart
#
...
OhdsiRTools::checkUsagePackage("CoDImputationHeart")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/CoDImputationHeart.pdf")
shell("R CMD Rd2pdf ./ --output=extras/CoDImputationHeart.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "CoDImputationHeart")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("CoDImputationHeart")
